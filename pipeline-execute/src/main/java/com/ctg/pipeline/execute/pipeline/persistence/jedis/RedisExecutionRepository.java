...
import static com.ctg.pipeline.execute.config.RedisConfiguration.Clients.EXECUTION_REPOSITORY;
import static com.ctg.pipeline.execute.model.Execution.ExecutionType.ORCHESTRATION;
import static com.ctg.pipeline.execute.model.Execution.NO_TRIGGER;
import static com.ctg.pipeline.execute.model.Execution.ExecutionType;
import static com.ctg.pipeline.execute.model.Execution.PausedDetails;
import static com.ctg.pipeline.execute.model.Execution.ExecutionType.ORCHESTRATION;
import static com.ctg.pipeline.execute.model.Execution.ExecutionType.PIPELINE;
import static com.ctg.pipeline.execute.model.ExecutionStatus.BUFFERED;
...
import com.ctg.pipeline.execute.exceptions.*;
...
public class RedisExecutionRepository implements ExecutionRepository {
  ...
  private final ObjectMapper mapper = ExecuteObjectMapper.getInstance();
