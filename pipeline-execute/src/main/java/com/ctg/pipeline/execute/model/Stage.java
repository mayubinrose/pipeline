...
import com.ctg.pipeline.execute.exceptions.ExecuteException;
...
public class Stage implements Serializable {
  ...
  @JsonIgnore private final transient ObjectMapper objectMapper = ExecuteObjectMapper.getInstance();
