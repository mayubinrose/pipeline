...
import com.netflix.spinnaker.orca.q.pending.RedisPendingExecutionService
...
open class RedisOrcaQueueConfiguration : RedisQueueConfiguration() {
  ...
  @Bean
  open fun orcaToKeikoSerializationMigrator(objectMapper: ObjectMapper) = OrcaToKeikoSerializationMigrator(objectMapper)
  ...
  open fun pendingExecutionService(
