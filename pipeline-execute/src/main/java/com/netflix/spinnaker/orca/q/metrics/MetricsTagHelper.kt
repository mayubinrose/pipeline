...
class MetricsTagHelper : CloudProviderAware {
  companion object {
    ...
    fun commonTags(stage: Stage, taskModel: com.ctg.pipeline.execute.model.Task, status: ExecutionStatus): Iterable<BasicTag> =
      arrayListOf(
    ...
    fun detailedTaskTags(stage: Stage, taskModel: com.ctg.pipeline.execute.model.Task, status: ExecutionStatus): Iterable<BasicTag> =
      arrayListOf(
